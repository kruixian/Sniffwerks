...
public class ActivityLog extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvLog.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String appName = TextUtils.join(", ", Util.getApplicationNames(uid, ActivityLog.this));
                String dateTime = SimpleDateFormat.getDateTimeInstance().format(time);
                ...
                // Packet information page
                //packetInfoIntent.putExtra("time", cursor.getLong(cursor.getColumnIndex("time")));

                passPacketInfo(dateTime, version, protocol, flags, saddr, sport, daddr, dport, dname, uid, appName);
    ...
    private void passPacketInfo(String dateTime, int version, int protocol, String flags, String saddr, int sport, String daddr, int dport, String dname, int uid, String appName)
    {
        Intent packetInfoIntent = new Intent(this, PacketInfo.class);

        packetInfoIntent.putExtra("dateTime", dateTime);

        packetInfoIntent.putExtra("version", version);
        packetInfoIntent.putExtra("protocol", protocol);
        packetInfoIntent.putExtra("flags", flags);
        packetInfoIntent.putExtra("saddr", saddr);
        packetInfoIntent.putExtra("sport", sport);
        packetInfoIntent.putExtra("daddr", daddr);
        packetInfoIntent.putExtra("dport", dport);
        packetInfoIntent.putExtra("dname", dname);
        packetInfoIntent.putExtra("uid", uid);
        packetInfoIntent.putExtra("appName", appName);

        startActivity(packetInfoIntent);
    }
